...
public class FragmentAnswer extends Fragment {
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            adapter = new AnswerAdapter(getActivity(), (List<Answer>) msg.obj);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        OkHttpUtils.asyPost(API.getAnswer, new OkHttpUtilsCallback() {
            ...
            public void onResponse(String response, String status) {
                Gson gson = new Gson();
                AnswerHolder answerHolder = gson.fromJson(response,AnswerHolder.class);
                Message message = new Message();
                message.obj = answerHolder.getAnswers();
            }
        },new OkHttpUtils.Param("questionId","1"));
        return view;
    }
